# AI-Driven Intrusion Detection Using Hybrid VAE–GNN Architecture
...
Encoding – Convert categorical to numeric values

Normalization – Scale features

Graph Conversion – Transform data into a graph for GNN

2. AI Model Pipeline

VAE: Learns normal behavior → detects anomalies

GNN: Understands node relationships → classifies attack patterns
